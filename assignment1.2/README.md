...
You **_MAY_** use the [main.ipynb](https://github.com/iCAS-Lab/2026-edge-computing/blob/main/assignment1.1/main.ipynb) code from the previous assignment to create, train, and test your network. Just be aware that you will need to change out the dataset, create your own VGG model, and develop the code to compute the latency.
